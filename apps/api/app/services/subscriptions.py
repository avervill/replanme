...
async def classify_prompt_feature_for_billing(prompt: str, *, has_image_attachment: bool = False) -> str | None:
    return classify_prompt_feature(prompt, has_image_attachment=has_image_attachment)
